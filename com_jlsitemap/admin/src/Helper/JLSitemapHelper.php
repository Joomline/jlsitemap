...
class JLSitemapHelper extends ContentHelper
{
	...
	{
		Sidebar::addEntry(Text::_('COM_JLSITEMAP_CONTROL_PANEL'),
			'index.php?option=com_jlsitemap&view=controlpanel',
			$vName == 'controlpanel');

		Sidebar::addEntry(Text::_('COM_JLSITEMAP_GENERATION'),
