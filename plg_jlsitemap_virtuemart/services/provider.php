...
use Joomla\Plugin\JLSitemap\Virtuemart\Extension\Virtuemart;
    ...
    public function register(Container $container)
    {
        $container->set(
            ...
            function (Container $container) {
                ...
                $config  = (array)PluginHelper::getPlugin('jlsitemap', 'virtuemart');
                $plugin  = new Virtuemart($subject, $config);
